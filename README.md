...
| **Outlier detection (IQR)**     | Rule: flag below **Q1 − 1.5×IQR** or above **Q3 + 1.5×IQR**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `outlier_detection_iqr.csv`.                                                                                                                                    | Debt ratio has about **~21%** rows flagged; age is **<0.04%**. DebtRatio: many rows are far from the typical middle range (very heavy tail).                                                                                                                                                                                             |
